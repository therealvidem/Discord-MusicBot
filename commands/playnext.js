...
module.exports = {
    name: "playnext",
    description: "Play your favorite songs and moves it to the first in queue",
    usage: "[song]",
    permissions: {
        ...
        try {
            if (SearchString.match(client.Lavasfy.spotifyPattern)) {
                ...
                if (Searched.loadType === "PLAYLIST_LOADED") {
                    ...
                    player.queue.add(TrackUtils.build(Searched.tracks[0], message.author), 0);
                    ...
                    if (player.queue.totalSize > 1) SongAddedEmbed.addField("Position in queue", `1`, true);
                    Searching.edit(SongAddedEmbed);
                } else {
                ...
                if (Searched.loadType === "NO_MATCHES") return client.sendTime(message.channel, "**No matches found for - **" + SearchString);
                    ...
                    player.queue.add(Searched.tracks[0], 0);
                    if (!player.playing && !player.paused && !player.queue.size) player.play();
                    SongAddedEmbed.setAuthor(`Added to queue`, client.botconfig.IconURL);
        ...
        run: async (client, interaction, args, { GuildDB }) => {
            ...
            if (search.match(client.Lavasfy.spotifyPattern)) {
                ...
                switch (Searched.loadType) {
                    ...
                    case "TRACK_LOADED":
                        player.queue.add(TrackUtils.build(Searched.tracks[0], member.user), 0);
                    ...
                    case "SEARCH_RESULT":
                        ...
                        let SongAdded = new MessageEmbed();
                            ...
                            if (player.queue.totalSize > 1) SongAdded.addField("Position in queue", `1`, true);
